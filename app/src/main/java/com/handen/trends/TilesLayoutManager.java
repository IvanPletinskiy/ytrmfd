...
public class TilesLayoutManager extends RecyclerView.LayoutManager {
    ...
    public TilesLayoutManager (GridSpanLookup spanLookup, int columns, float callAspectRatio) {
    ...
    @Keep
    public TilesLayoutManager (Context context, AttributeSet attributeSet, int defStyleAttr,
                               int defStyleRes) {
        TypedArray typedArray = context.obtainStyledAttributes(
                attributeSet, R.styleable.SpannedGridLayoutManager, defStyleAttr, defStyleRes);
        ...
        int orientation = typedArray.getInt(R.styleable.SpannedGridLayoutManager_android_orientation,
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if(dy < 0) {
            ...
            View child = getChildAt(firstPositionOfLastRow - firstVisiblePosition);
 ...
 //               System.err.println("228");
    ...
    public View findViewByPosition(int position) {
        if(position < firstVisiblePosition || position > lastVisiblePosition) {
            TextView textView = new TextView(getChildAt(0).getContext());
...
//        System.err.println("Position: " + Integer.toString(position) + " cells.size() " + Integer.toString(cells.size()));
        ...
        return integer;
//        System.err.println("cells.get(position).row " + Integer.toString(integer));
